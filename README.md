...
## Action and asset creation workflow update

- Create action moved to its own page, linked from the Action tickets header below the ticket stats.
- Add equipment / asset moved to its own page, linked from the Asset list header on the same line as the title.
