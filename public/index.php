...
if (route() === 'users') {
    ...
    if ($canRoles) {
        echo '<div class="card"><details><summary><strong>Role guide</strong></summary><div class="role-guide-grid">';
        foreach($allRoles as $role){ echo '<div class="asset-field"><span>'.e($role['display_name']).'</span><strong>'.e($role['description'] ?: $role['name']).'</strong></div>'; }
