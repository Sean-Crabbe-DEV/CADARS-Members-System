    ...
    foreach($users as $usr){
        ...
        if ($canRoles) {
            ...
            foreach($allRoles as $role){
                ...
                echo '<label class="check"><input type="checkbox" name="roles[]" value="'.e($role['name']).'" '.$checked.' '.$disabled.'><span>'.e($role['display_name']).'</span></label>';
            }
