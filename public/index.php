...
if (route() === 'equipment') {
    ...
    echo '<section class="card asset-list-card"><div class="dash-card-head"><div><h2>Asset list</h2><p class="muted">Open an asset to view details and track maintenance tickets/history.</p></div></div>';
    if(!$rows) {
...
if (route() === 'committee_actions') {
    ...
    echo '<section class="card action-list-card"><div class="dash-card-head"><div><h2>Action tickets</h2><p class="muted">Open, in-progress and completed committee actions.</p></div><div class="action-mini-stats"><span><strong>'.e($openCount).'</strong> open</span><span><strong>'.e($progressCount).'</strong> in progress</span><span><strong>'.e($closedCount).'</strong> closed</span></div></div><div class="actions-board">';
